...
--
[[rust-analyzer.semanticHighlighting.operator.specialization.logicalNot.enable]]rust-analyzer.semanticHighlighting.operator.specialization.logicalNot.enable (default: `false`)::
+
--
